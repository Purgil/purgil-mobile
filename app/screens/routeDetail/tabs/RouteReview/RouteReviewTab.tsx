...
import { Avatar, RatingStars } from '~/components/shared'
import WriteReviewActionSheet from '~/screens/routeDetail/tabs/RouteReview/components/WriteRouteReviewActionSheet.tsx'
import { reviews } from '~/screens/routeDetail/tabs/RouteReview/RouteReviewTab.consts.ts'
import RouteReviewListItem from '~/components/route/RouteReviewListItem.tsx'
...
export default function RouteReviewTab() {
  /** state */
  ...
  return (
    <ScrollView collapsable>
      ...
      <FlatList
        ...
        data={reviews}
        renderItem={({ item }) => (
          <RouteReviewListItem key={item.id} review={item} />
        )}
      />
